...
import { PurchaseReturnFormHeader } from "../components/PurchaseReturnForm/PurchaseReturnFormHeader";
import { PurchaseReturnFormTable } from "../components/PurchaseReturnForm/PurchaseReturnFormTable";
import { PurchaseReturnFormMobile } from "../components/PurchaseReturnForm/PurchaseReturnFormMobile";
      ...
      <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="min-w-0">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">
            {editId ? "Edit Purchase Return" : "Create Purchase Return"}
          </h1>
          <p className="text-sm text-gray-500">
            Manage purchase return details and item quantities
          </p>
        </div>
      </div>
