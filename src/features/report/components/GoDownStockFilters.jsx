    ...
    <div className={`border border-gray-200 rounded-xl ${ButtonConfig.cardheaderColor} shadow-sm p-4 mb-6`}>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="shrink-0">
          <h1 className="text-xl font-bold text-gray-800 tracking-tight">Stock Godown Summary</h1>
          <p className="text-sm text-gray-500">View detailed stock reports filtered by godown and items.</p>
        </div>
...
export default GoDownStockFilters;
