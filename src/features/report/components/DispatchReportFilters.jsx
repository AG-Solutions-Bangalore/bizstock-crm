    ...
    <div className={`border border-gray-200 rounded-xl ${ButtonConfig.cardheaderColor} shadow-sm p-4 mb-6`}>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="shrink-0">
          <h1 className="text-xl font-bold text-gray-800 tracking-tight">Dispatch Report</h1>
          <p className="text-sm text-gray-500">Track and monitor all item dispatches and buyer history.</p>
        </div>
...
export default DispatchReportFilters;
